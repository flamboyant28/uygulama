...
if _kayit_et("Calibri", _calibri_normal) and _kayit_et("Calibri-Bold", _calibri_bold):
    PDF_FONT      = "Calibri"
    PDF_FONT_BOLD = "Calibri-Bold"
elif _kayit_et("DejaVu", _dejavu_normal) and _kayit_et("DejaVu-Bold", _dejavu_bold):
    PDF_FONT      = "DejaVu"
