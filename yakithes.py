...
if _ev_sarj_sayisi <= 1:
    st.markdown(f"""<div style="background:linear-gradient(135deg,#4a1a7a,#7030A0);color:white;
      padding:12px 22px;border-radius:12px;display:flex;align-items:center;gap:14px;
      font-size:0.95rem;font-weight:700;box-shadow:0 3px 10px rgba(112,48,160,.3);margin-top:6px">
      <div style="font-size:1.6rem">⚡</div>
      <div><div>ELEKTRİKLİ ARAÇ — TEK ŞARJLA GİDİLİR</div>
      <div style="font-weight:400;font-size:0.82rem;opacity:.85;margin-top:2px">
      Tam şarj menzili {ev_menzil:.0f} km · Yol {yol} km · Varışta {_ev_sarj_kalan:.0f} km menzil kalır</div>
      </div></div>""", unsafe_allow_html=True)
else:
    st.markdown(f"""<div style="background:linear-gradient(135deg,#1a1a7a,#2E4DE0);color:white;
      padding:12px 22px;border-radius:12px;display:flex;align-items:center;gap:14px;
      font-size:0.95rem;font-weight:700;box-shadow:0 3px 10px rgba(46,77,224,.3);margin-top:6px">
      <div style="font-size:1.6rem">⚡</div>
      <div><div>ELEKTRİKLİ ARAÇ — {_ev_sarj_sayisi} ŞARJ GEREKLİ</div>
      <div style="font-weight:400;font-size:0.82rem;opacity:.85;margin-top:2px">
      Tam şarj menzili {ev_menzil:.0f} km · Yol {yol} km · Her {ev_menzil:.0f} km'de bir şarj</div>
      </div></div>""", unsafe_allow_html=True)
