...
NAMES = {
    ...
    "Türkiye": {
        "first": [
            ...
            "Mustafa Can", "Mustafa Emre", "Mustafa Kemal", "Mustafa Burak",
            "Ali Can", "Ali Emre", "Ali Kerem", "Ali Furkan", "Hasan Hüseyin", "Hasan Can", "Hasan Basri",
            "Hüseyin Can", "Hüseyin Emre", "İbrahim Halil", "İbrahim Can", "İbrahim Ethem",
            "Yusuf Emre", "Yusuf Can", "Yusuf Kerem", "Ömer Faruk", "Ömer Can", "Ömer Halis",
            "Abdullah Can", "Abdullah Emre", "Emirhan", "Emirhan Can", "Emirhan Ali",
            "Furkan Can", "Furkan Emre", "Furkan Ali", "Enes Can", "Enes Emre", "Enes Ali",
            "Burak Can", "Burak Emre", "Onur Can", "Onur Emre",
            "Kerem Can", "Kerem Ali", "Oğuzhan Can", "Oğuzhan Emre",
            "Batuhan Can", "Batuhan Emre", "Talha Can", "Talha Emre",
            "Samet Can", "Samet Emre", "Yasin Can", "Yasin Emre",
            "Halil İbrahim", "Halil Can", "Recep Can",
            "Bilal Can", "Bilal Emre", "Harun Can", "Harun Emre",
            "Salih Can", "Salih Emre", "Kaan Can", "Kaan Emre",
            "Mert Can", "Mert Emre", "Efe Can", "Efe Emre",
            "Arda Can", "Arda Emre", "Hasan Basri",
            "Mehmet Talha", "Mehmet Salih", "Mehmet Hüseyin", "Mehmet Burak", "Mehmet Enes",
            "Mehmet Onur", "Mehmet Samet", "Mehmet Serkan", "Mehmet Kaan", "Mehmet Arda",
            "Ahmet Talha", "Ahmet Salih", "Ahmet Onur", "Ahmet Samet", "Ahmet Kaan",
            "Ahmet Arda", "Ahmet Batuhan", "Ahmet Oğuzhan", "Ahmet Serhat", "Ahmet Berk",
            "Mustafa Talha", "Mustafa Salih", "Mustafa Onur", "Mustafa Samet", "Mustafa Kaan",
            "Mustafa Arda", "Mustafa Efe", "Mustafa Oğuz", "Mustafa Serhat", "Mustafa Berk",
            "Ali Talha", "Ali Salih", "Ali Onur", "Ali Samet", "Ali Kaan",
            "Ali Arda", "Ali Efe", "Ali Oğuz", "Ali Serhat", "Ali Berk",
            "Hasan Ali", "Hasan Emre", "Hasan Furkan", "Hasan Talha", "Hasan Oğuz",
            "Hasan Kaan", "Hasan Berk", "Hasan Efe", "Hasan Arda",
            "Hüseyin Ali", "Hüseyin Furkan", "Hüseyin Talha", "Hüseyin Oğuz",
            "Hüseyin Kaan", "Hüseyin Berk", "Hüseyin Efe", "Hüseyin Arda",
            "İbrahim Talha", "İbrahim Salih", "İbrahim Onur", "İbrahim Samet",
            "İbrahim Kaan", "İbrahim Arda", "İbrahim Berk", "İbrahim Efe",
            "Yusuf Talha", "Yusuf Salih", "Yusuf Onur", "Yusuf Samet",
            "Yusuf Kaan", "Yusuf Arda", "Yusuf Berk", "Yusuf Efe",
            "Ömer Talha", "Ömer Salih", "Ömer Onur", "Ömer Samet",
            "Ömer Kaan", "Ömer Arda", "Ömer Berk", "Ömer Efe",
            "Abdullah Talha", "Abdullah Salih", "Abdullah Onur", "Abdullah Samet",
            "Abdullah Kaan", "Abdullah Arda", "Abdullah Berk", "Abdullah Efe",
            "Furkan Talha", "Furkan Salih", "Furkan Onur", "Furkan Samet",
            "Furkan Kaan", "Furkan Arda", "Furkan Berk", "Furkan Efe",
            "Enes Talha", "Enes Salih", "Enes Onur", "Enes Samet",
            "Enes Kaan", "Enes Arda", "Enes Berk", "Enes Efe",
            "Burak Talha", "Burak Salih", "Burak Onur", "Burak Samet",
            "Burak Kaan", "Burak Arda", "Burak Berk", "Burak Efe",
            "Onur Talha", "Onur Salih", "Onur Samet", "Onur Kaan",
            "Onur Arda", "Onur Berk", "Onur Efe",
            "Kerem Talha", "Kerem Salih", "Kerem Onur", "Kerem Samet",
            "Kerem Kaan", "Kerem Arda", "Kerem Berk", "Kerem Efe",
            "Oğuzhan Talha", "Oğuzhan Salih", "Oğuzhan Onur", "Oğuzhan Samet",
            "Oğuzhan Kaan", "Oğuzhan Arda", "Oğuzhan Berk", "Oğuzhan Efe",
            "Batuhan Talha", "Batuhan Salih", "Batuhan Onur", "Batuhan Samet",
            "Batuhan Kaan", "Batuhan Arda", "Batuhan Berk", "Batuhan Efe",
            "Talha Emre", "Talha Ali", "Talha Kaan", "Talha Arda", "Talha Berk", "Talha Efe",
            "Samet Ali", "Samet Kaan", "Samet Arda", "Samet Berk", "Samet Efe",
            "Yasin Ali", "Yasin Kaan", "Yasin Arda", "Yasin Berk", "Yasin Efe",
            "Halil Can", "Halil Emre", "Halil Talha", "Halil Arda", "Halil Berk",
            "Recep Can", "Recep Emre", "Recep Talha", "Recep Arda", "Recep Berk",
            "Bilal Can", "Bilal Emre", "Bilal Talha", "Bilal Arda", "Bilal Berk",
            "Harun Can", "Harun Emre", "Harun Talha", "Harun Arda", "Harun Berk",
            "Salih Can", "Salih Emre", "Salih Talha", "Salih Arda", "Salih Berk",
            "Kaan Emre", "Kaan Ali", "Kaan Talha", "Kaan Arda", "Kaan Berk", "Kaan Efe",
            "Mert Emre", "Mert Ali", "Mert Talha", "Mert Arda", "Mert Berk", "Mert Efe",
            "Efe Emre", "Efe Ali", "Efe Talha", "Efe Arda", "Efe Berk",
            "Arda Emre", "Arda Ali", "Arda Talha", "Arda Berk", "Arda Efe"
        ],
        "last": [
...
HEIGHT_BY_BASE = {
    "KL":    (185, 196), "DOS":  (182, 194), "D":    (176, 188),
...
ROLE_POOLS = {
    "D":          ["Standart Bek (S)","Standart Bek (D)","Standart Bek (H)","Çakılı Bek (S)","İki Yönlü Bek (D)","İki Yönlü Bek (H)","Sahte Bek (D)","Sahte Bek (H)"],
    "D (Sol)":    ["Standart Sol Bek (S)","Standart Sol Bek (D)","Standart Sol Bek (H)","Çakılı Sol Bek (S)","İki Yönlü Sol Bek (D)","İki Yönlü Sol Bek (H)","Sahte Sol Bek (D)","Sahte Sol Bek (H)"],
    "D (Sağ)":    ["Standart Sağ Bek (S)","Standart Sağ Bek (D)","Standart Sağ Bek (H)","Çakılı Sağ Bek (S)","İki Yönlü Sağ Bek (D)","İki Yönlü Sağ Bek (H)","Sahte Sağ Bek (D)","Sahte Sağ Bek (H)"],
    "KB":         ["Kanat Bek (S)","Kanat Bek (D)","Kanat Bek (H)","Standart Bek (D)","İki Yönlü Bek (H)"],
    "KB (Sol)":   ["Sol Kanat Bek (S)","Sol Kanat Bek (D)","Sol Kanat Bek (H)","Standart Sol Bek (D)","İki Yönlü Sol Bek (H)"],
    ...
    "DM":         ["Ön Libero (S)","Defansif Orta Saha (S)","Defansif Orta Saha (D)","Regista (D)","Serbest Defansif (D)","Defansif Oyun Kurucu (D)"],
    "OS":         ["Savaşçı Orta Saha (S)","Savaşçı Orta Saha (D)","Gezgin Oyun Kurucu (D)","İki Yönlü Orta Saha (D)","Dinamo (D)","Mezzala (D)","Mezzala (H)"],
    "KANAT":      ["Defansif Kanat (S)","Çalışkan Kanat (D)","Kanat Oyun Kurucu (H)","Ters Ayaklı Kanat (H)","Kanat Oyuncusu (H)"],
    "KANAT (Sol)":["Sol Kanat (S)","Sol Çalışkan Kanat (D)","Sol Kanat Oyun Kurucu (H)","Sol Ters Ayaklı Kanat (H)","Sol Kanat Oyuncusu (H)"],
    "KANAT (Sağ)":["Sağ Kanat (S)","Sağ Çalışkan Kanat (D)","Sağ Kanat Oyun Kurucu (H)","Sağ Ters Ayaklı Kanat (H)","Sağ Kanat Oyuncusu (H)"],
    "OOS":        ["On Numara (H)","Ofansif Orta Saha (D)","Ofansif Orta Saha (H)","Ofansif Oyun Kurucu (H)","Raumdeuter (H)","Enganche (D)"],
    ...
    "ST":         ["Gizli Forvet (H)","Fırsatçı Golcü (H)","Yaratıcı Forvet (H)","Sahte Forvet (D)","Komple Forvet (H)","Pivot Santrafor (H)","Çalışkan Forvet (S)","Çalışkan Forvet (H)"],
...
POSITION_ATTR_MEANS = {
    "ST": {
        "Bitiricilik":13,"Dripling":11,"İlk Kontrol":11,"Kafa Vuruşu":10,"Uzaktan Şut":10,"Teknik":9,
        "Pas":8,"Orta Yapma":3,"Top Kapma":4,"Markaj":3,"Korner":3,"Penaltı Kullanma":9,"Serbest Vuruş Kullanma":6,"Uzun Taç":3,
        "Topsuz Alan":13,"Soğukkanlılık":12,"Pozisyon Alma":11,"Karar Alma":11,"Önsezi":11,"Çalışkanlık":9,
        "Vizyon":7,"Konsantrasyon":9,"Takım Oyunu":8,"Agresiflik":7,"Cesaret":9,"Liderlik":6,"Kararlılık":9,"Özel Yetenek":8,
        "Hız":12,"Hızlanma":12,"Çeviklik":10,"Denge":9,"Dayanıklılık":10,"Güç":10,"Zıplama":11,"Vücut Zindeliği":10,
    },
    "KF": {
        "Bitiricilik":11,"Dripling":13,"İlk Kontrol":12,"Kafa Vuruşu":7,"Uzaktan Şut":9,"Teknik":12,
        "Pas":9,"Orta Yapma":7,"Top Kapma":4,"Markaj":3,"Korner":4,"Penaltı Kullanma":7,"Serbest Vuruş Kullanma":6,"Uzun Taç":3,
        "Topsuz Alan":12,"Soğukkanlılık":11,"Pozisyon Alma":10,"Karar Alma":10,"Önsezi":11,"Çalışkanlık":10,
        "Vizyon":9,"Konsantrasyon":9,"Takım Oyunu":9,"Agresiflik":7,"Cesaret":8,"Liderlik":6,"Kararlılık":9,"Özel Yetenek":10,
        "Hız":13,"Hızlanma":13,"Çeviklik":12,"Denge":11,"Dayanıklılık":10,"Güç":8,"Zıplama":8,"Vücut Zindeliği":10,
    },
    "OOS": {
        "Bitiricilik":9,"Dripling":11,"İlk Kontrol":13,"Kafa Vuruşu":6,"Uzaktan Şut":8,"Teknik":13,
        "Pas":13,"Orta Yapma":6,"Top Kapma":5,"Markaj":4,"Korner":10,"Penaltı Kullanma":7,"Serbest Vuruş Kullanma":12,"Uzun Taç":3,
        "Topsuz Alan":11,"Soğukkanlılık":12,"Pozisyon Alma":10,"Karar Alma":12,"Önsezi":12,"Çalışkanlık":9,
        "Vizyon":13,"Konsantrasyon":10,"Takım Oyunu":10,"Agresiflik":6,"Cesaret":7,"Liderlik":10,"Kararlılık":9,"Özel Yetenek":12,
        "Hız":10,"Hızlanma":11,"Çeviklik":11,"Denge":10,"Dayanıklılık":9,"Güç":7,"Zıplama":6,"Vücut Zindeliği":9,
    },
    "KANAT": {
        "Bitiricilik":7,"Dripling":12,"İlk Kontrol":11,"Kafa Vuruşu":6,"Uzaktan Şut":7,"Teknik":11,
        "Pas":10,"Orta Yapma":13,"Top Kapma":5,"Markaj":5,"Korner":9,"Penaltı Kullanma":5,"Serbest Vuruş Kullanma":6,"Uzun Taç":3,
        "Topsuz Alan":11,"Soğukkanlılık":9,"Pozisyon Alma":9,"Karar Alma":10,"Önsezi":10,"Çalışkanlık":11,
        "Vizyon":10,"Konsantrasyon":9,"Takım Oyunu":10,"Agresiflik":7,"Cesaret":7,"Liderlik":6,"Kararlılık":8,"Özel Yetenek":8,
        "Hız":13,"Hızlanma":13,"Çeviklik":11,"Denge":10,"Dayanıklılık":11,"Güç":7,"Zıplama":7,"Vücut Zindeliği":10,
    },
    "OS": {
        "Bitiricilik":7,"Dripling":9,"İlk Kontrol":12,"Kafa Vuruşu":7,"Uzaktan Şut":7,"Teknik":11,
        "Pas":13,"Orta Yapma":8,"Top Kapma":9,"Markaj":7,"Korner":11,"Penaltı Kullanma":5,"Serbest Vuruş Kullanma":10,"Uzun Taç":5,
        "Topsuz Alan":9,"Soğukkanlılık":11,"Pozisyon Alma":12,"Karar Alma":12,"Önsezi":11,"Çalışkanlık":12,
        "Vizyon":12,"Konsantrasyon":11,"Takım Oyunu":12,"Agresiflik":9,"Cesaret":8,"Liderlik":9,"Kararlılık":11,"Özel Yetenek":9,
        "Hız":9,"Hızlanma":9,"Çeviklik":9,"Denge":10,"Dayanıklılık":12,"Güç":10,"Zıplama":7,"Vücut Zindeliği":11,
    },
    "DM": {
        "Bitiricilik":5,"Dripling":7,"İlk Kontrol":10,"Kafa Vuruşu":8,"Uzaktan Şut":5,"Teknik":9,
        "Pas":11,"Orta Yapma":6,"Top Kapma":12,"Markaj":10,"Korner":4,"Penaltı Kullanma":4,"Serbest Vuruş Kullanma":5,"Uzun Taç":5,
        "Topsuz Alan":6,"Soğukkanlılık":11,"Pozisyon Alma":13,"Karar Alma":12,"Önsezi":11,"Çalışkanlık":12,
        "Vizyon":9,"Konsantrasyon":12,"Takım Oyunu":12,"Agresiflik":11,"Cesaret":10,"Liderlik":8,"Kararlılık":11,"Özel Yetenek":7,
        "Hız":8,"Hızlanma":8,"Çeviklik":9,"Denge":10,"Dayanıklılık":12,"Güç":11,"Zıplama":8,"Vücut Zindeliği":11,
    },
    "DOS": {
        "Bitiricilik":4,"Dripling":4,"İlk Kontrol":9,"Kafa Vuruşu":12,"Uzaktan Şut":4,"Teknik":8,
        "Pas":10,"Orta Yapma":4,"Top Kapma":13,"Markaj":13,"Korner":3,"Penaltı Kullanma":4,"Serbest Vuruş Kullanma":4,"Uzun Taç":6,
        "Topsuz Alan":4,"Soğukkanlılık":11,"Pozisyon Alma":13,"Karar Alma":12,"Önsezi":10,"Çalışkanlık":10,
        "Vizyon":7,"Konsantrasyon":12,"Takım Oyunu":10,"Agresiflik":11,"Cesaret":12,"Liderlik":9,"Kararlılık":12,"Özel Yetenek":6,
        "Hız":9,"Hızlanma":9,"Çeviklik":8,"Denge":10,"Dayanıklılık":11,"Güç":13,"Zıplama":12,"Vücut Zindeliği":11,
    },
    "D": {
        "Bitiricilik":4,"Dripling":7,"İlk Kontrol":9,"Kafa Vuruşu":10,"Uzaktan Şut":4,"Teknik":8,
        "Pas":9,"Orta Yapma":9,"Top Kapma":12,"Markaj":12,"Korner":4,"Penaltı Kullanma":4,"Serbest Vuruş Kullanma":4,"Uzun Taç":5,
        "Topsuz Alan":5,"Soğukkanlılık":11,"Pozisyon Alma":12,"Karar Alma":11,"Önsezi":9,"Çalışkanlık":10,
        "Vizyon":6,"Konsantrasyon":11,"Takım Oyunu":10,"Agresiflik":10,"Cesaret":11,"Liderlik":7,"Kararlılık":11,"Özel Yetenek":5,
        "Hız":9,"Hızlanma":9,"Çeviklik":9,"Denge":10,"Dayanıklılık":11,"Güç":12,"Zıplama":9,"Vücut Zindeliği":11,
    },
    "KB": {
        "Bitiricilik":5,"Dripling":9,"İlk Kontrol":10,"Kafa Vuruşu":7,"Uzaktan Şut":5,"Teknik":9,
        "Pas":10,"Orta Yapma":12,"Top Kapma":11,"Markaj":10,"Korner":7,"Penaltı Kullanma":4,"Serbest Vuruş Kullanma":4,"Uzun Taç":5,
        "Topsuz Alan":7,"Soğukkanlılık":10,"Pozisyon Alma":10,"Karar Alma":10,"Önsezi":9,"Çalışkanlık":11,
        "Vizyon":8,"Konsantrasyon":9,"Takım Oyunu":11,"Agresiflik":9,"Cesaret":9,"Liderlik":7,"Kararlılık":10,"Özel Yetenek":6,
        "Hız":12,"Hızlanma":12,"Çeviklik":11,"Denge":10,"Dayanıklılık":12,"Güç":9,"Zıplama":8,"Vücut Zindeliği":11,
    },
    "KL": {
        "Bitiricilik":2,"Dripling":2,"İlk Kontrol":7,"Kafa Vuruşu":4,"Uzaktan Şut":2,"Teknik":4,
        "Pas":9,"Orta Yapma":2,"Top Kapma":2,"Markaj":3,"Korner":2,"Penaltı Kullanma":4,"Serbest Vuruş Kullanma":2,"Uzun Taç":9,
        "Topsuz Alan":3,"Soğukkanlılık":12,"Pozisyon Alma":4,"Karar Alma":12,"Önsezi":11,"Çalışkanlık":9,
        "Vizyon":8,"Konsantrasyon":12,"Takım Oyunu":9,"Agresiflik":6,"Cesaret":11,"Liderlik":10,"Kararlılık":11,"Özel Yetenek":7,
        "Hız":5,"Hızlanma":5,"Çeviklik":11,"Denge":10,"Dayanıklılık":8,"Güç":9,"Zıplama":11,"Vücut Zindeliği":10,
    },
}

for _sol, _sag, _base in [("D (Sol)","D (Sağ)","D"),("KB (Sol)","KB (Sağ)","KB"),("KANAT (Sol)","KANAT (Sağ)","KANAT"),("KF (Sol)","KF (Sağ)","KF")]:
...
ATTACK_ATTRS  = {"Bitiricilik","Uzaktan Şut","Topsuz Alan","Soğukkanlılık","Dripling","Penaltı Kullanma","Serbest Vuruş Kullanma","Korner"}
...
def generate_all_attributes(position, age, preset, country, target_ca):
    means   = POSITION_ATTR_MEANS[position]
    ...
    for attr in TECHNICAL:
        ...
        if attr in ATTACK_ATTRS:  val = min(val, POSITION_ATTACK_CAP.get(position,20))
        if attr in DEFENSE_ATTRS: val = min(val, POSITION_DEFENSE_CAP.get(position,20))
        if attr == "Kafa Vuruşu":  val = min(val, HEADING_CAP.get(position, 20))
        tech[attr] = val
...
def calculate_transfer_value(ca, pa, age):
    ...
    base = (ca / 200) ** 2.2 * 400_000_000
    value = base * age_factor * potential_bonus

    if value >= 80_000_000:    return f"{value / 1_000_000:.0f} Milyon €"
    elif value >= 10_000_000:  return f"{value / 1_000_000:.1f} Milyon €"
    elif value >= 1_000_000:   return f"{value / 1_000_000:.2f} Milyon €"
    elif value >= 100_000:     return f"{value / 1_000:.0f}Bin €"
...
def render_attributes_colored(title, attrs):
    ...
    for k,v in attrs.items():
        if   v<=4:  color="#9e9e9e"
        elif v<=9:  color="#e0e0e0"
        elif v<=13: color="#f1c40f"
        elif v<=16: color="#2ecc71"
        else:       color="#3498db"
...
with tab1:
    ...
    with c1: age     = st.slider("Yaş", 15, 40, 22)
    with c2: country = st.selectbox("Ülke", list(COUNTRY_PROFILES.keys()))
    with c3:
    ...
    if st.button("🎲 Oyuncu Üret", type="primary"):
        ...
        tech, mental, phys, gk, hidden = generate_all_attributes(position, age, preset, country, target_ca)
    ...
    if st.session_state.gen_player:
        ...
        name     = gp["name"];    flag   = gp["flag"];   country_g = gp["country"]
        age_g    = gp["age"];     position_g = gp["position"]
        preset_g = gp["preset"];  pa     = gp["pa"]
        foot     = gp["foot"];    weak_foot = gp["weak_foot"]
        dominant_foot_val = gp["dominant_foot_val"]
        height   = gp["height"];  weight = gp["weight"];  role = gp["role"]
        traits   = gp["traits"]
        ...
        grade_color = {"A":"#2ecc71","B":"#27ae60","C":"#f1c40f","D":"#e67e22","E":"#e74c3c"}.get(grade,"#aaa")
        ...
        with col_left:
            ...
            if traits:
                st.subheader("💡 PPM")
                for t in traits:
                    st.markdown(f"<span style='background:#21262d;border-radius:12px;padding:3px 10px;font-size:12px;color:#ccc'>{t}</span>", unsafe_allow_html=True)
        ...
        with col_right:
            ...
            st.caption("⚫ ≤4   ● 5-9   🟡 10-13   🟢 14-16   🔵 17+  |  ✏️ Değerleri düzenleyebilirsin — CA otomatik güncellenir")
            ...
            def editable_attr_col(title, attr_dict, prefix):
                ...
                for attr, default_val in attr_dict.items():
                    ...
                    # Renge göre stil
                    if cur_val >= 17:   vc = "#3498db"; dot = "🔵"
                    elif cur_val >= 14: vc = "#2ecc71"; dot = "🟢"
                    elif cur_val >= 10: vc = "#f1c40f"; dot = "🟡"
                    elif cur_val >= 5:  vc = "#e0e0e0"; dot = "●"
                    else:               vc = "#9e9e9e"; dot = "⚫"
                    col_l, col_r = st.columns([2, 1])
                    col_l.markdown(
                        f"<div style='font-size:0.73rem;color:#aaa;padding:2px 0;line-height:1.4'>"
                        f"{attr} <span style='color:{vc};font-weight:700;font-size:0.78rem'>{cur_val}</span>"
                        f"</div>",
                        unsafe_allow_html=True
                    )
        ...
        tbl = "<div style='overflow-x:auto'><table style='border-collapse:collapse;font-size:0.72rem;white-space:nowrap'>"
        # Başlık
        ...
        for sec_label, sec_color, attr_list in cat_sections:
            ...
            for attr, src_dict in attr_list:
                ...
                tbl += f"<td style='padding:2px 10px;color:#ccc;position:sticky;left:0;background:#0d1117;font-size:0.72rem'>{attr}</td>"
                for yr in periods:
...
with tab3:
    ...
    with mc1: man_pos     = st.selectbox("Mevki", ALL_POSITIONS, key="man_pos")
    with mc2: man_wf      = st.slider("Zayıf Ayak (1-20)", 1, 20, 8, key="man_wf")
    with mc3: man_country = st.selectbox("Ülke", list(COUNTRY_PROFILES.keys()), key="man_country")
    ...
    man_cols = st.columns(4 if not is_gk else 5)
    ...
    man_grade_color = {"A":"#2ecc71","B":"#27ae60","C":"#f1c40f","D":"#e67e22","E":"#e74c3c"}.get(man_grade,"#aaa")
    ...
    with res_mid:
        ...
        for attr, val, w in top_weighted:
            ...
            st.markdown(f"<span style='color:{c};font-size:12px'>● {attr}: <b>{val}</b> <span style='color:#555'>(×{w:.1f})</span></span>", unsafe_allow_html=True)
...
with tab4:
    ...
    FORMATION_PITCH = {
        ...
        "4-4-2":   [(5,0),(1,1),(2.7,1),(5,1),(7.3,1),(1,2.5),(3.3,2.5),(6.7,2.5),(9,2.5),(3.5,4),(6.5,4)],
        "4-2-3-1": [(5,0),(1,1),(2.7,1),(5,1),(7.3,1),(3,2),(7,2),(1,3.2),(5,3.2),(9,3.2),(5,4.2)],
        "3-5-2":   [(5,0),(2.5,1),(5,1),(7.5,1),(9,2),(1,2),(3.5,2.5),(5,2),(6.5,2.5),(3.5,4),(6.5,4)],
        "3-4-3":   [(5,0),(2.5,1),(5,1),(7.5,1),(9,2.2),(1,2.2),(4,3),(6,3),(1,4),(5,4.2),(9,4)],
        "5-3-2":   [(5,0),(1,1),(2.5,1),(5,1),(7.5,1),(9,1),(2.5,2.5),(5,2.5),(7.5,2.5),(3.5,4),(6.5,4)],
...
with sq_col2:
    if st.button("⚽ Kadro Üret", type="primary", key="sq_btn"):
        ...
        for p in squad:
            ca_color = "#3498db" if p["CA"]>=170 else "#2ecc71" if p["CA"]>=150 else "#f1c40f" if p["CA"]>=120 else "#e0e0e0"
...
with tab5:
    ...
    with sim_tab1:
        ...
        if st.button("🎲 Sezonu Simüle Et", type="primary", key="ss_btn"):
            ...
            def _S(key): return sum(m[key] for m in all_mstats)
            ...
            if games_played > 0:
                ...
                def match_stat_text(d, pb):
                    if   pb == "ST":    return f"{d['gol']}G {d['asist']}A  {d['sut']}Şut"
                    elif pb == "KF":    return f"{d['gol']}G {d['asist']}A  {d['dribling']}Dr"
                    elif pb == "OOS":   return f"{d['gol']}G {d['asist']}A  {d['kp']}KP"
                    elif pb == "KANAT": return f"{d['gol']}G {d['asist']}A  {d['orta']}Orta"
                    elif pb == "OS":    return f"{d['asist']}A  {d['topk']}TopK  {d['pas']}Pas"
                    elif pb == "DM":    return f"{d['asist']}A  {d['topk']}TopK  {d['pas']}Pas"
                    elif pb == "KB":    return f"{d['asist']}A  {d['topk']}TopK  {d['orta']}Orta"
                    elif pb == "D":     return f"{d['topk']}TopK  {d['mud']}Müd  {d['pas']}Pas"
                    elif pb == "DOS":   return f"{d['topk']}TopK  {d['mud']}Müd  {d['blok']}Blok"
                    elif pb == "KL":    return f"{d['kurtaris']}Kur  {d['cs']}GoY"
                    return "—"
    ...
    with sim_tab2:
        ...
        st.caption("Oyuncunu 15 yaşından emekliliğe kadar yönet. Her yıl antrenman odağı seç, kulüp seç, gelişimi takip et.")
        ...
        if cp:
            ...
            g_color = {"A":"#2ecc71","B":"#27ae60","C":"#f1c40f","D":"#e67e22","E":"#e74c3c"}.get(grade,"#aaa")
            st.markdown(f"""
            ...
            if st.session_state.career_log:
                ...
                if is_gk_career:
                    headers = ["Sezon","Yaş","Kulüp","Lig","Maç","Kurtarış","Gol Yemedi","Not","CA","ΔCA","Odak","Sakatlık"]
                else:
                    headers = ["Sezon","Yaş","Kulüp","Lig","Maç","Gol","Asist","⚡ Katkı","Not","CA","ΔCA","Odak","Sakatlık"]
                for h in headers:
